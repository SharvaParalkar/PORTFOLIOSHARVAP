/**
 * CMS-AUTH — Cloudflare Worker OAuth proxy for Decap CMS (GitHub login).
 * Based on sveltia-cms-auth (MIT): https://github.com/sveltia/sveltia-cms-auth
 */
...
export default {
  async fetch(request, env) {
    ...
    return new Response('CMS-AUTH ready. Use /auth and /callback.', { status: 200 });
  },
};
